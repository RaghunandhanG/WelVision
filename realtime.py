...
import os
import psutil
from database import create_table , upload_data
...
if 'selected_option' not in st.session_state:
    directory = r"C:\Users\Raghunandhan G\Desktop\WelVision\models"
    st.session_state.selected_option = directory + "\\" + [f for f in os.listdir(directory) if os.path.isfile(os.path.join(directory, f))] [0]
model_path = st.session_state.selected_option 
    ...
    if start_detection:
        ...
        while cap_1.isOpened() and cap_2.isOpened():
            ...
            if ret_1 and ret_2:
                ...
                upload_data(total_defective_bearings_per_sec_1,total_defective_bearings_per_sec_2)
